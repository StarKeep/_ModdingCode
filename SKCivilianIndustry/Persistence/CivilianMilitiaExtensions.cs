...
namespace SKCivilianIndustry.Persistence
{
    public static class CivilianMilitiaExtensions
    {
        ...
        public static CivilianMilitia GetCivilianMilitiaExt(this GameEntity_Squad ParentObject, ExternalDataRetrieval rule )
        {
            return (CivilianMilitia)ParentObject.ExternalData.GetCollectionByPatternIndex((int)CivilianMilitiaExternalData.PatternIndex, rule )?.Data[0];
        }
        ...
        {
            ParentObject.ExternalData.GetCollectionByPatternIndex((int)CivilianMilitiaExternalData.PatternIndex, ExternalDataRetrieval.CreateIfNotFound ).Data[0] = data;
        }
    }
}
