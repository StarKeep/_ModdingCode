...
namespace SKCivilianIndustry.Persistence
{
    public static class CivilianPlanetExtensions
    {
        ...
        public static CivilianPlanet GetCivilianPlanetExt(this Planet ParentObject, ExternalDataRetrieval rule )
        {
            return (CivilianPlanet)ParentObject.ExternalData.GetCollectionByPatternIndex((int)CivilianPlanetExternalData.PatternIndex, rule )?.Data[0];
        }
        ...
        {
            ParentObject.ExternalData.GetCollectionByPatternIndex((int)CivilianPlanetExternalData.PatternIndex, ExternalDataRetrieval.CreateIfNotFound ).Data[0] = data;
        }
